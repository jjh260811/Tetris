...
public class SidePanel extends JPanel {
	...
	private static final Font SFont = new Font("함초롱돋움",Font.BOLD, 13);
	/**
	 * The large font.
	 */
	
	private static final Font LFont = new Font("함초롱돋움",Font.BOLD, 15);
	/**
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("조작법:P",SMALL_INSET , offset = CONTROLS_INSET+60);
		/* 
		g.setFont(SFont);
